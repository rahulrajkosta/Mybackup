  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        ...
        <h4><?php if(!empty($this->dataStore("myData")->toArray())){echo "from ".$this->dataStore("myData")->toArray()[0]['date_of_purchase'] ;?> to <?=$this->dataStore("myData")->toArray()[count($this->dataStore("myData")->toArray())-1]['date_of_purchase']; }?></h4></h3>
