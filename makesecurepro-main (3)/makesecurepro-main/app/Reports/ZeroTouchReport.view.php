  ...
  <div class="col-12">
    <div class="card">
      ...
      <h3 class="content-header-title text-dark">Zero Touch Details report 
        <h4><?php if(!empty($this->dataStore("zero_touch_data")->toArray())){echo "from ".$this->dataStore("zero_touch_data")->toArray()[0]['Dates'] ;?> to <?=$this->dataStore("zero_touch_data")->toArray()[count($this->dataStore("zero_touch_data")->toArray())-1]['Dates']; }?></h4></h3>
