                ...
                if ($mobile_detail->app_status == 'remove') {
                    ...
                    if ($mobile_detail->phone_status == 'unlock') {
						...
						if(!empty($request->device_token)){
							$upd=array('phone_status' => 'unlock', 'app_status' => '','device_token'=>$request->device_token,'device_time'=>date('Y-m-d H:i:s'));
						}else{
							$upd=array('phone_status' => 'unlock', 'app_status' => '');
						}
                        MobileDetails::where('id', $mobile_detail->id)->update($upd);
                        $type = 'unlock';
                        $device_token = $request->device_token??'';
