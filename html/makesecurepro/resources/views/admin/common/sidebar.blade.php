...
// echo $url;
  ...
  <!-- BEGIN: Main Menu-->
  <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="{{url('/public/assets/antitheft/')}}/app-assets/images/backgrounds/02.jpg">
