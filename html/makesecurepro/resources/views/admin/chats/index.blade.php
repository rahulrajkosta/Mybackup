              ...
              <div class="row justify-content-between py-1">
                <div class="col-sm-7">
                  <div class="d-flex align-items-start">
                    <img src="{{asset('public/assets/new/images/users/user-3.jpg')}}" class="me-2 rounded-circle" height="36" alt="Brandon Smith">
                    <div>
            ...
            <div class="card-body">
              <ul class="conversation-list chat-list" data-simplebar style="max-height: 460px;" id="chat_scroll">
                ...
                <li class="clearfix">
                  ...
                  <!--   <img src="{{asset('public/assets/new/images/users/user-3.jpg')}}" class="rounded" alt="James Z" />
                    <i>10:00</i> -->
                  </div>
                ...
                <!-- <li class="clearfix odd">
                  <div class="chat-avatar">
                    <img src="{{asset('public/assets/new/images/users/user-1.jpg')}}" class="rounded" alt="Geneva M" />
                    <i>10:01</i>
                  </div>
                  <div class="conversation-text">
                    <div class="ctext-wrap">
               ...
               <!--  <li class="clearfix">
                  <div class="chat-avatar">
                    <img src="{{asset('public/assets/new/images/users/user-5.jpg')}}" class="rounded" alt="James Z" />
                    <i>10:01</i>
                  </div>
                  <div class="conversation-text">
                    <div class="ctext-wrap">
                ...
                <li class="clearfix">
                  <div class="chat-avatar">
                    <img src="{{asset('public/assets/new/images/users/user-5.jpg')}}" alt="James Z" class="rounded" />
                    <i>10:02</i>
                  </div>
                  <div class="conversation-text">
                    <div class="ctext-wrap">
                ...
                <!-- <li class="clearfix odd">
                  <div class="chat-avatar">
                    <img src="{{asset('public/assets/new/images/users/user-1.jpg')}}" alt="Geneva M" class="rounded" />
                    <i>10:03</i>
                  </div>
                  <div class="conversation-text">
                    <div class="ctext-wrap">
