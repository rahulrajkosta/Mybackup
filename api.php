...
Route::middleware('auth:sanctum')->group( function () {
						Route::resource('users_table', users_table_Controller::class);
						Route::get('chtoken', [users_table_Controller::class,'check_token']);
						Route::get('Vtoken/{token}', [users_table_Controller::class,'Verify_token']);
						Route::get('Vtoken/{token}', [users_table_Controller::class,'Verify_token']);
						Route::post('user_tbl/upload', [users_table_Controller::class,'upload']);
						Route::get('user_tbl/getImg', [users_table_Controller::class,'getImg']);
