		...
		if($Basic_gem_suggestion){
            ...
            $validate=array();
                    foreach($input as $key => $value) {
                        ...
                        if (array_key_exists('LIFE',$input))
			{
				$validate['LIFE']= "required";
			} 
		 if (array_key_exists('BENEFIC',$input))
			{
				$validate['BENEFIC']= "required";
			} 
		 if (array_key_exists('LUCKY',$input))
			{
				$validate['LUCKY']= "required";
			} 
		 if (array_key_exists('user_id',$input))
			{
				$validate['user_id']= "required";
