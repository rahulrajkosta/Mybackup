<?php
/**
 * Astrology CURL Client for consuming Astrology CURLs
 * https://astrologyCURL.com/
...
*/
    ...
    private function packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name,$varshaphal_year)
    {
        $dd= array(
            'day' => $date,
            'month' => $month,
        ...
        if(!empty($varshaphal_year)){
            $dd['varshaphal_year']=$varshaphal_year;
        }
        return $dd;
    }
    ...
    public function getDailyNakshatraPrediction($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
        $resourceName = 'daily_nakshatra_prediction';
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name);
        $response = $this->getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
    ...
    public function getBirthDetails($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getAstroDetails($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getPlanetsDetails($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getPlanetsExtendedDetails($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getPlanetsTropicalDetails($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getAshtakvargaDetails($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $planet,$name)
    {
    ...
    public function getSarvashtakDetails($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getBasicPanchang($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getPlanetPanchang($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getBasicPanchangSunrise($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
        $resourceName = 'basic_panchang/sunrise';
        $data = $this->packageHoroData($data, $month, $year, 0, 0, $latitude, $longitude, $timezone,$name);
        $response = $this->getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }

    public function getPlanetPanchangSunrise($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getAdvancedPanchang($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getAdvancedPanchangSunrise($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getChaughadiyaMuhurta($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getHoraMuhurta($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getCurrentVimDasha($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getCurrentVimDashaAll($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getMajorVimDasha($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getMajorYoginiDasha($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getSubYoginiDasha($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getCurrentYoginiDasha($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getMajorCharDasha($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getCurrentCharDasha($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getSubCharDasha($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $rashiName,$name)
    {
    ...
    public function getSubSubCharDasha($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $rashiName, $subRashiName,$name)
    {
    ...
    public function getKalsarpaDetails($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    /*public function getKalsarpaRemedies($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getPitriDoshaReport($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getSadhesatiLifeDetails($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getSadhesatiCurrentStatus($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getSadhesatiRemedies($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getManglikDetails($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    /*public function getManglikRemedies($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getHoroChartById($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $chartId,$name)
    {
    ...
    public function getExtendedHoroChartById($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $chartId,$name)
    {
    ...
    public function getBasicGemSuggestion($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getPujaSuggestion($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getRudrakshaSuggestion($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getGeneralHouseReport($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $planetName,$name)
    {
    ...
    public function getGeneralRashiReport($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $planetName,$name)
    {
    ...
    public function getNakshatraReport($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getAscendantReport($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name)
    {
    ...
    public function getWheelChartTropical($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name){

        $resourceName = 'wheel_chart/tropical';
        $data = $this->packageWesternData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name);
        $response = $this->getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, 'en');
        return $response;

    }
    
    public function call($resourceName, $date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name=null,$varshaphal_year=null){
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name,$varshaphal_year);
        $resData = $this->getCurlReponse($this->userId, $this->apiKey,$resourceName, $data, $this->language);
        return $resData;
    }
    ...
    public function generatePdf($endpoint,$date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name=null,$varshaphal_year=null)
    {
        $data = $this->packageHoroData($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone,$name,$varshaphal_year);
        $response = $this->getCurlResponsePDF($endpoint,$this->userId, $this->apiKey, $data, $this->language);
        return $response;
    }

    private function getCurlResponsePDF($endpoint,$userId, $apiKey, array $data, $language)
    {
        $apiEndPoint = "https://pdf.astrologyapi.com/v1/".$endpoint;
