...
class Horo_chart_image_chartid_Controller extends BaseController
{
    ...
    public function update(Request $request,$id)
    {
		...
		if($Horo_chart_image_chartid){
		 ...
		 if (array_key_exists('planetColor',$input))
			{
				$validate['planetColor']= "required";
			} 
		 if (array_key_exists('signColor',$input))
			{
				$validate['signColor']= "required";
			} 
		 if (array_key_exists('lineColor',$input))
			{
				$validate['lineColor']= "required";
			} 
		 if (array_key_exists('chartType',$input))
			{
				$validate['chartType']= "required";
			} 
