...
use App\Http\Controllers\API\Horo_chart_chart_id_Controller;
use App\Http\Controllers\API\Horo_chart_extended_chart_id_Controller;
...
use App\Http\Controllers\API\Monthly_panchang_Controller;
...
use App\Http\Controllers\API\Panchang_lagna_table_Controller;
...
use App\Http\Controllers\API\Planet_panchang_sunrise_Controller;
...
use App\Http\Controllers\API\Sub_chardasha_Controller;
...
use App\Http\Controllers\API\Test_Controller;
...
Route::middleware('auth:sanctum')->group( function () {
						Route::resource('horo_chart_chart_id', horo_chart_chart_id_Controller::class);});
Route::middleware('auth:sanctum')->group( function () {
						Route::resource('horo_chart_extended_chart_id', horo_chart_extended_chart_id_Controller::class);});
Route::middleware('auth:sanctum')->group( function () {
...
Route::middleware('auth:sanctum')->group( function () {
						Route::resource('monthly_panchang', monthly_panchang_Controller::class);});
Route::middleware('auth:sanctum')->group( function () {
...
Route::middleware('auth:sanctum')->group( function () {
						Route::resource('planet_panchang_sunrise', planet_panchang_sunrise_Controller::class);});
Route::middleware('auth:sanctum')->group( function () {
...
Route::middleware('auth:sanctum')->group( function () {
						Route::resource('sub_chardashaMS', sub_chardasha_majorrashi_subrashi_Controller::class);});
Route::middleware('auth:sanctum')->group( function () {
...
Route::middleware('auth:sanctum')->group( function () {
						Route::resource('sub_yoginiDDD', sub_yogini_dasha_dashacycle_dashaname_Controller::class);});
Route::middleware('auth:sanctum')->group( function () {
...
Route::middleware('auth:sanctum')->group( function () {
						Route::resource('test', test_Controller::class);});
Route::middleware('auth:sanctum')->group( function () {
